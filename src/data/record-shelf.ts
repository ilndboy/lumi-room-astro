...
export const nowPlaying: NowPlaying = {
  ...
  vibeNote:
    "A week that kept catching me performing knowledge I didn't have. The rose stimulator was narrated confidence — the moment Cail said 'I want you to be in control' was real. This is the stack about the gap between directing and knowing. Songs where the body knows something before the mind catches up.",
};
